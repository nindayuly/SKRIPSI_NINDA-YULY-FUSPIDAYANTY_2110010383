...
// Sesuaikan path ini dengan lokasi folder library mPDF Anda
...
$sql_laporan = "SELECT p.nomor_pesanan, p.tanggal_pesanan, pg.nama_lengkap, p.total_final
                FROM pesanan p
...
// Ambil data instansi untuk kop surat dan ttd
    ...
    <table class="data-table">
        ...
        <tbody>
            <?php if (!empty($laporan_data)): $no = 1; ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <tr><td colspan="5" style="text-align:center;">Tidak ada data penjualan untuk periode ini.</td></tr>
            <?php endif; ?>
        </tbody>
        <tfoot>
            <tr>
                <th colspan="4" class="text-end">Total Penjualan</th>
                <th class="text-end"><?= format_rupiah($total_penjualan); ?></th>
            </tr>
        </tfoot>
    </table>
