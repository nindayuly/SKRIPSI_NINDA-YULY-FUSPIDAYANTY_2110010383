...
function scrollToBottom() {
    setTimeout(() => {
        var scrollEl = new SimpleBar(document.querySelector('.email-menu-sidebar-scroll'));
        scrollEl.getScrollElement().scrollTop = document.querySelector(".mail-list").scrollHeight;
    }, 100);
}
